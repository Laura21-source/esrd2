                ...
                <div class="container-fluid">
                    ...
                    <table id="dataTable" class="table table-striped table-bordered table-sm table-hover" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <th class="th-sm font-weight-bold alert-primary " width="50%">Фамилия, Имя Отчество</th>
                            <th class="th-sm font-weight-bold alert-primary " width="20%">Должность</th>
                            <th class="th-sm font-weight-bold alert-primary " width="20%">Телефон</th>
                        </tr>
                        </thead>
                        <tbody id="rowContent">
                        </tbody>
...
<script>
    $(function() {
        adminDataTableArray("#dataTable","rest/profile/users", 1);
    });
</script>

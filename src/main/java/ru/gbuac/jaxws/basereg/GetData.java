...
public class GetData  implements java.io.Serializable {
    ...
    /**
     * Gets the request value for this GetData.
     * 
     * @return request
     */
    ...
    /**
     * Sets the request value for this GetData.
     * 
     * @param request
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">GetData"));

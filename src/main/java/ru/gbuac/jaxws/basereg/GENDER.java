...
public class GENDER implements java.io.Serializable {
    ...
    public static final java.lang.String _М = "М";
    public static final java.lang.String _Ж = "Ж";
    public static final GENDER М = new GENDER(_М);
    public static final GENDER Ж = new GENDER(_Ж);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/Common", "GENDER"));
    }
    /**

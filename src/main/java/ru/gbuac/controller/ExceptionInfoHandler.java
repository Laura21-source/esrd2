...
import ru.gbuac.util.ValidationUtil;
import ru.gbuac.util.exception.ApplicationException;
import ru.gbuac.util.exception.ErrorInfo;
import ru.gbuac.util.exception.ErrorType;
...
import static ru.gbuac.util.exception.ErrorType.*;
